...
int iStoreAddbotPersonality;
int iStoreAddbotTeam;
int iStoreFillServerSkill;
int iStoreFillServerPersonality;
int iStoreFillServerTeam;
...
bot_weapon_select_t cs_weapon_select[NUM_WEAPONS + 1] =
{
   ...
   {CS_WEAPON_XM1014,    "weapon_xm1014",    "models/w_xm1014.mdl",    "xm1014", "buy;menuselect 2;menuselect 2",   0.0, 2048.0, 0.0, 1200.0,  TRUE,  TRUE,   0.9, 3000, 1,  2,  1, FALSE},
   // Sub Machine Guns
   ...
   // Sniper Rifles
   {CS_WEAPON_SCOUT,     "weapon_scout",     "models/w_scout.mdl",     "scout",  "buy;menuselect 4;menuselect 5", 300.0, 4096.0, 0.0, 1200.0,  TRUE, FALSE,   2.2, 2750, 1,  2,  0,  TRUE},
   ...
   {CS_WEAPON_G3SG1,     "weapon_g3sg1",     "models/w_g3sg1.mdl",     "g3sg1",  "buy;menuselect 4;menuselect 7", 300.0, 4096.0, 0.0, 1200.0,  TRUE, FALSE,   4.9, 5000, 1,  0, -1,  TRUE},
...
menutext_t menuPODBotKickBotTeam =
{
   0x213,
   " Kick Bot From:\n"
   "\n"
