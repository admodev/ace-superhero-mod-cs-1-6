...
extern int iStoreAddbotPersonality;
extern int iStoreAddbotTeam;
extern int iStoreFillServerSkill;
extern int iStoreFillServerPersonality;
extern int iStoreFillServerTeam;
...
extern menutext_t menuPODBotKickBotTeam;
